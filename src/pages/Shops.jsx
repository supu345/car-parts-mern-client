...
const Shops = () => {
  ...
  return (
    <div>
      <Headers />
      <section className='bg-[url("https://images.pexels.com/photos/2920063/pexels-photo-2920063.jpeg?auto=compress&cs=tinysrgb&w=600")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
